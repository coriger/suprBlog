                            ...
                            <div class="ibox-content">
                                <form method="get" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <img id="thumbShowPic" data-dz-thumbnail="" src="<%=basePath%>uploads/${article.thumbUrl}" style="width:80px">
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <input type="hidden" id="thumbPicUrl" value="${article.thumbUrl}"/>
                                        </div>
                                    </div>
